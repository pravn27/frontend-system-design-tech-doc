...
const config = {
  ...
  tagline:
    "Everything about Frontend System Design, its reference links & technical documentations",
  ...
  baseUrl: "/frontend-system-design-tech-doc/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "pravn27", // Usually your GitHub org/user name.
  projectName: "frontend-system-design-tech-doc", // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            "https://github.com/pravn27/frontend-system-design-tech-doc/tree/master",
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        items: [
          {
            to: "/docs/category/fsd-documentations",
